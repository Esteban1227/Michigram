...
export const createTitleCategory = (title) =>
    h(
...
export const createCardCategory = (michi,results) =>
    h(
        "article",{
            classList:"mainContainer__containerCard mainContainer__containerCards--cardCategory"
        },
        h(
